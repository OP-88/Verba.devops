...
if __name__ == "__main__":
    ...
    def ensure_float32_audio(self, audio_data):
        """Ensure audio data is in float32 format for Whisper compatibility"""
        if audio_data.dtype != np.float32:
            ...
            audio_data = self.ensure_float32_audio(audio_data)
        return audio_data
